...
3) TYPE "streamlit run check.py --server.port 8501 --server.enableCORS true --server.enableXsrfProtection false" in the terminal of your IDE and press enter
4) ONCE You're connected, other clients can connect to by typing "http://[Your Host IP]:8501" in their browser
5) FOR MYSQL CONNECTION:
